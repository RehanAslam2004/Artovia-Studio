...
export async function uploadFile(file, folder = 'products') {
    ...
    try {
        ...
        // Add a 5-minute timeout for Cloudinary upload
        ...
        if (error.name === 'AbortError') {
            return {
                success: false,
                error: 'Upload was aborted. This usually happens if the file exceeds size limits or the connection was lost.'
            };
        }
